...
public class FunctionalElementsListener implements MouseListener {
	...
	public FunctionalElementsListener(ElementColection elementColection, Color mouseIn, Color mouseOut, ClickAction action) {
