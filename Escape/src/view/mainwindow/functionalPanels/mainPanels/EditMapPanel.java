...
public class EditMapPanel extends FunctionalPanel{
	...
	public EditMapPanel()
	{
		...
		addDangerPanel = new FunctionalButtonBackgroundPanel(addDanger);
		...
		loadMapPanel = new FunctionalButtonBackgroundPanel(loadMap);
		
		editMap = new FunctionalButton("functionalPanelsIcons\\EditMap.png", "Edit map");
		editMapPanel = new FunctionalButtonBackgroundPanel(editMap);
		
		createMap = new FunctionalButton("functionalPanelsIcons\\NewMap.png", "Create new map");
		createMapPanel = new FunctionalButtonBackgroundPanel(createMap);
